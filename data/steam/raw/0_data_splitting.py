...
user_item = json.load(open(os.path.join(root_data, "user_item_map.json")))
user_item = {int(i): user_item[i] for i in user_item}
...
item_set = json.load(open(os.path.join(root_data, "item_set.json")))
